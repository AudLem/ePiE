...
The script auto-detects the GitHub repo URL and downloads from the v1.26.3 release. It verifies SHA-256 checksums and skips files that are already present (safe to re-run).
...
- The release must exist: `gh release view v1.26.3` or check https://github.com/AudLem/ePiE/releases
