VoltaDryNetwork <- function(data_root, output_root) {
  ...
  list(
    ...
    reference_river_shp_path = bc$wet_river_shp_path,
    preserve_downstream_from_reference = TRUE,
    ...
    run_output_dir = file.path(output_root, "volta_dry"),
